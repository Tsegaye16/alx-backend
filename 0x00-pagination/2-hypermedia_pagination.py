#!/usr/bin/env python3
"""
Defining the class with methods to create simple pagination from csv data
"""
import csv
...
class Server:
    ...
    def dataset(self) -> List[List]:
        """
        Reading from csv file and returns the dataset.
        """
    ...
    def assert_positive_integer_type(value: int) -> None:
        """
        Asserting the value is a positive integer.
        """
